...
Step 2. Run the "Actions > Encode Movie > MP4" menu item.
...
def EncodeMovie(path):
	...
	dest = dir + os.sep + 'H264_Encode.' + ext
...
# Create the action
class EncodeMovieMP4(Action):
	"""Encode a movie in Compressor."""
	
	def __init__(self):
		Action.__init__(self, 'Encode Movie|MP4')
